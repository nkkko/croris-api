# this is the second version of the script that fetches data from the Croatian Scientific Bibliography (CROSBI) API.
# it was used first on 10th of May 2024 to feetch publications.pkl file with 832871 records and 2.3 GB in size
# to run it: nohup python3 crosbiAllPub.py &
